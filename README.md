...
### IncepTR: Micro-Expression Recognition Integrating Inception-CBAM and Vision Transformer [![paper](https://img.shields.io/badge/Paper-87CEEB)](https://link.springer.com/article/10.1007/s00530-023-01164-0) <br> 
...
2. There are 68 raws in _subName.txt_, reference to [subName.txt](https://github.com/HaoliangZhou/Dual-ATME/blob/master/data/MEGC2019/v_cde_flow/subName.txt): 
```
006
...
037
